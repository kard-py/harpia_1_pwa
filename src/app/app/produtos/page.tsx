...
export default async function Page() {
  const data = await fetch("http://localhost:3010/produtos", { method: "get" }).catch(err => null).then(res => res);
  if (data != null) {
